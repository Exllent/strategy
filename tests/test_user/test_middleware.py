...
@pytest.mark.parametrize(
    "user, status_code",
    [("not_authenticated", 403), ("authenticated", 403), ("admin_authenticated", 200)],
)
def test_forbidden_admin_page_middleware(
    create_user, create_castle, client, create_admin, user, status_code
):
    url = "/admin/"
    match user:
