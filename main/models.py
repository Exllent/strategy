...
class Castle(models.Model):
    ...
    wood = models.PositiveSmallIntegerField(default=0, validators=[Max(limit_value=1_000_000)], verbose_name="Дерево")
    stones = models.PositiveSmallIntegerField(default=0, validators=[Max(limit_value=1_000_000)], verbose_name="Камень")
    iron = models.PositiveSmallIntegerField(default=0, validators=[Max(limit_value=1_000_000)], verbose_name="Железо")
    food = models.PositiveSmallIntegerField(default=0, validators=[Max(limit_value=1_000_000)], verbose_name="Еда")
...
class MilitaryBuildings(models.Model):
    ...
    castle = models.ForeignKey(to=Castle, blank=True, null=True, on_delete=models.PROTECT,
                               verbose_name="Замок")
